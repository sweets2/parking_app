...
Mode switching:
- setActiveMode("check") clears Rules inspection layers and shows Check controls.
- setActiveMode("rules") clears Check result layers and shows Rules controls.
...
- Check and Rules nav labels must be exactly "Check" and "Rules".
